...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        btn = [[
            ...
            InlineKeyboardButton(' 🔍 ʏᴀɴᴅᴇx 🔎', url=f'https://yandex.com/search?text={reqst_imd}')
        ],[
...
async def auto_filter(client, msg, spoll=False):
    ...
    if imdb and imdb.get('poster'):
        try:
            ...
            logger.exception(e)
            await message.reply_photo(photo='https://telegra.ph/file/1352172a6983f9279de16.jpg',caption=cap, disable_web_page_preview=True, reply_markup=InlineKeyboardMarkup(btn))
    else:
        await message.reply_photo(photo='https://telegra.ph/file/1352172a6983f9279de16.jpg', caption=cap, disable_web_page_preview=True, reply_markup=InlineKeyboardMarkup(btn))
    if spoll:
...
async def advantage_spell_chok(client, msg):
    ...
    try:
        ...
        k = await msg.reply_photo(
            ...
            text=script.SPELL_CHECK_ENG, #IN SCRIPT CHANGE DONOT CHANGE CODE
            reply_markup=InlineKeyboardMarkup(btn),
